...
const ProjectsContent: React.FC = () => {
  ...
  //       Ini adalah beberapa proyek yang saya buat. Proyek-proyek ini tidak hanya
  //       membantu saya membangun portofolio saya, namun juga meningkatkan
  //       keterampilan yang telah saya kembangkan.
  //     </p>
  //   </motion.div>
  // );
};
