    ...
    <>
      ...
      <motion.p
        ...
        <span className="font-semibold">
          1+ Tahun Telah Menggunakan Teknologi Web Untuk membuat aplikasi dan
          situs web yang dapat diandalkan.
        </span>{" "}
        Menggunakan teknologi HTML, CSS, JavaScript, dan Framework PHP untuk
        membuat website yang dinamis dan mudah digunakan oleh pengguna.
      </motion.p>
    </>
  );
};
