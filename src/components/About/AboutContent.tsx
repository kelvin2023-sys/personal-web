  ...
  return (
    <motion.div
      ...
      <motion.p
        ...
        Halo, saya Kelvin! Saya bersemangat dalam pengembangan frontend dan
        berkomitmen untuk terus memperluas pengetahuan dan keterampilan saya
        dalam pengembangan frontend, memberikan kode yang bersih, dan belajar
        teknologi baru.
      </motion.p>
    </motion.div>
  );
